...
import 'package:ebook_app/Pages/DeleteBook/DeleteBooks.dart';
...
class BookMangerHome extends StatelessWidget {
  const BookMangerHome({Key? key}) : super(key: key);
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                      height:
                          20), // Moved this SizedBox inside the closing parenthesis of the Column
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Column(
                          ...
                          ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => DeleteBooksPage()),
                              );
                            },
                            style: ElevatedButton.styleFrom(
