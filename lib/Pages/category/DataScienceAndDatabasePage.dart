...
class DataScienceAndDatabasePage extends StatelessWidget {
  final String selectedCategory;

  final BookController bookController = Get.find();

  DataScienceAndDatabasePage({Key? key, required this.selectedCategory})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Data Science And Database "),
        centerTitle: true,
      ),
