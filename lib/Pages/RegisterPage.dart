...
class _RegisterState extends State<Register> {
  ...
  postDetailsToFirestore(String email, String role) async {
    ...
    if (role == 'User') {
      ...
      userRef.doc(user!.uid).set({'email': emailController.text, 'role': role});
    } else if (role == 'Book Manager') {
      CollectionReference bookManagerRef =
          FirebaseFirestore.instance.collection('Book Manager');
      bookManagerRef
          .doc(user!.uid)
